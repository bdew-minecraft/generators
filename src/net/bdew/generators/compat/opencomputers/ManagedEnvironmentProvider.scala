...
class ManagedEnvironmentProvider[T <: TileEntity](kind: String, commands: TileCommandHandler[T], tile: T) extends AbstractManagedEnvironment with ManagedPeripheral with NamedBlock {
