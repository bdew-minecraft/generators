...
object OutputSlotsExchanger extends SlotSet("fluidslots_exchanger") {
  val BOTH = Slot("BOTH", "advgenerators.exchanger.output.both", Texture(Textures.sheet, 101, 35, 14, 14))
  val COLD = Slot("COLD", "advgenerators.exchanger.output.cold", Texture(Textures.sheet, 133, 35, 14, 14))
  val HOT = Slot("HOT", "advgenerators.exchanger.output.hot", Texture(Textures.sheet, 117, 35, 14, 14))
