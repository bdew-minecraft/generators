...
class GasHandlerOptional(base: () => Option[IFluidHandler], getWorld: () => World) extends IGasHandler {
...
object GasHandlerOptional {
  def create(base: () => Option[IFluidHandler], getWorld: () => World): LazyOptional[IGasHandler] = {
